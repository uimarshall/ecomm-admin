...
const ShopDetailitemPage: React.FC = () => {
                  ...
                  <div className="flex flex-col gap-12 items-start justify-start w-full">
                    ...
                    <div className="flex md:flex-col flex-row gap-10 items-start justify-start w-full">
                      <div className="flex flex-1 flex-col gap-6 items-start justify-start w-full">
                        <div className="flex flex-row gap-3 items-center justify-start w-full">
                          <div className="bg-indigo-400 h-0.5 w-[8%]"></div>
                          <Text
                      ...
                      <div className="flex flex-1 flex-col gap-8 items-start justify-start w-full">
                        <div className="flex flex-col gap-4 items-start justify-start w-full">
                          ...
                          <Text
                            className="leading-[24.00px] max-w-[523px] md:max-w-full text-base text-bluegray-800"
                        ...
                        <div className="flex flex-col gap-4 items-start justify-start w-full">
                          ...
                          <Text
                            className="leading-[24.00px] text-base text-bluegray-800"
                            size="txtInterRegular16Bluegray800"
                          >
                            <span className="text-bluegray-800 font-inter text-left font-medium">
                              Size:
                            </span>
                            <span className="text-bluegray-800 font-inter text-left font-normal">
                              <>
                                {" "}
                                S<br />
                                <br />
