...
const CalendarDay1EventPage: React.FC = () => {
              ...
              <div className="flex md:flex-col flex-row font-inter gap-5 items-start justify-start w-full">
                ...
                <div className="bg-white-A700 flex flex-1 flex-col items-center justify-center sm:px-5 px-[30px] py-[26px] rounded shadow-bs w-full">
                  <div className="flex flex-col gap-[30px] items-center justify-center w-full">
                    ...
                    <div className="border border-indigo-50 border-solid flex flex-col gap-2 h-[642px] md:h-auto items-start justify-start py-3 w-full">
                      ...
                      <div className="bg-indigo-400 flex flex-col items-start justify-start px-4 py-1 rounded w-full">
                        <div className="flex flex-col items-center justify-start w-[32%] md:w-full">
                          <div className="flex flex-row items-start justify-between pb-[3px] w-[98%] md:w-full">
                            <Img
...
export default CalendarDay1EventPage;
