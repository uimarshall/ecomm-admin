    ...
    <>
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-inter sm:gap-5 md:gap-5 items-start justify-start mx-auto w-auto sm:w-full md:w-full">
        ...
        <div className="flex flex-1 flex-col gap-6 items-center justify-start md:px-5 w-full">
          ...
          <div className="flex flex-col font-poppins items-center justify-start sm:px-5 px-6 w-full">
            <div className="flex flex-col gap-8 items-center justify-start w-full">
              ...
              <div className="flex md:flex-col flex-row font-inter gap-5 items-start justify-center w-full">
                ...
                <div className="bg-white-A700 flex flex-1 flex-col h-[762px] md:h-auto items-center justify-start sm:px-5 px-[30px] py-[26px] rounded shadow-bs w-full">
                  <div className="flex flex-col gap-[30px] h-full items-center justify-start w-full">
                    ...
                    <div className="flex flex-col h-full items-start justify-start w-full">
                      ...
                      >
                        <div className="flex flex-1 flex-col h-12 md:h-auto items-center justify-center sm:ml-[0] outline outline-[0.5px] outline-indigo-50 sm:px-5 px-[33px] py-[13px] w-full">
                          <Text
                      ...
                      <div className="flex md:flex-col flex-row md:gap-5 h-full items-start justify-start w-full">
                        <div className="flex flex-1 flex-col h-full items-start justify-end outline outline-[0.5px] outline-indigo-50 p-4 w-full">
                          <Button className="bg-indigo-400 cursor-pointer font-medium py-1.5 rounded text-center text-sm text-white-A700 w-full">
                            8:10 am
                          </Button>
                        </div>
                        <div className="flex-1 h-[592px] outline outline-[0.5px] outline-indigo-50 w-full"></div>
                        <div className="flex-1 h-[592px] outline outline-[0.5px] outline-indigo-50 w-full"></div>
                        <div className="flex-1 h-[592px] outline outline-[0.5px] outline-indigo-50 w-full"></div>
                        <div className="flex-1 h-[592px] outline outline-[0.5px] outline-indigo-50 w-full"></div>
                        <div className="flex-1 h-[592px] outline outline-[0.5px] outline-indigo-50 w-full"></div>
